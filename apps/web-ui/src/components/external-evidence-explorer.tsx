  ...
  return (
    <div className="workspace-page">
      <WorkspacePageHeader
        actions={
          <>
            ...
            <a
              ...
              href={`${apiBaseUrl}${workspace.export_csv_href}`}
            >
        ...
        description="Navigate the local evidence warehouse through server-backed search, source filters, and review posture slices before opening the full record detail. This surface is read-first and keeps provenance explicit."
        title="Evidence intelligence explorer"
      />

      <section className="workspace-stats-grid">
        <WorkspaceStatCard
          detail="Rows currently visible on the returned page for the active filter state."
          label="Visible page rows"
          tone="accent"
          value={workspace.warehouse_snapshot.returned_item_count}
        />
        <WorkspaceStatCard
          detail="Claims represented across the full filtered warehouse, not just the current page slice."
          label="Warehouse claims"
          tone="success"
          value={workspace.warehouse_snapshot.claim_count}
        />
        <WorkspaceStatCard
          detail="Matching warehouse rows that retain a DOI for citation-aware follow-up."
          label="Warehouse rows with DOI"
          value={workspace.warehouse_snapshot.doi_count}
        />
        <WorkspaceStatCard
          detail="Matching warehouse rows that expose an external source URL for direct inspection."
      ...
      >
        <div className="workspace-card-list">
          <WorkspaceDataCard tone="accent">
            ...
            <p>
              This brief never upgrades pending evidence into accepted evidence.
              It summarizes the filtered warehouse snapshot and the current-page
              spotlight rows only after you request it.
            </p>
            ...
            {assistantRequested ? (
                  ...
                  <div className="workspace-detail-grid">
                    ...
                    <article className="workspace-inline-card">
                      ...
                      {assistant.assistant.cited_evidence_ids.length > 0 ? (
                        <div className="workspace-chip-list compact">
                          {assistant.assistant.cited_evidence_ids.map((id) => (
                        ...
                        <p className="muted">
                          No current-page spotlight rows were available to cite.
                        </p>
                      )}
                    </article>
                  </div>
              ...
              <p className="muted">
                Generate the brief when you want a warehouse-aware summary for
                the current filters.
              </p>
            )}
          </WorkspaceDataCard>
