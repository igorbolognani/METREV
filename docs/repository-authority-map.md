...
| Active signed-in refactor slice      | `specs/033-ui-api-database-rule-engine-refactor/`                                                                                                                     | Current owner for client/admin workspace separation and EvidenceDecisionContext promotion across runtime, API, database, and rule-engine layers.          |
