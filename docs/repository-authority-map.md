...
| Internal feature workflow            | `docs/internal-feature-workflow.md`, `specs/_templates/`, root `.github/prompts/`, root `.github/agents/`, root `.github/skills/`                                     | Use the root-owned workflow surface for maintained feature work.                                                                                        |
