...
const pendingCatalogItem: ExternalEvidenceCatalogItemDetail = {
  ...
  source_document: {
    id: 'source-doc-catalog-pending-001',
    source_type: 'crossref',
    source_category: 'scholarly_work',
    source_url: 'https://doi.org/10.1000/example',
    doi: '10.1000/example',
    ...
    access_status: 'green',
    license: 'CC BY-NC',
    pdf_url: 'https://example.test/pending.pdf',
    xml_url: null,
    authors: [],
  },
  claims: [],
  scientific_facts: [
    {
      ...
      source_text_hash: 'hash-fact-pending-001',
      quality_flags: [],
      payload: {
    ...
    },
    {
      ...
      source_text_hash: 'hash-fact-pending-002',
  ...
  benchmark_records: [
    {
      id: 'benchmark-pending-001',
      canonical_key: 'power_density',
      decision_ready: true,
      confidence: 0.9,
      system_type: 'MFC',
      application: 'wastewater pilot',
      component_type: 'anode',
      material: 'carbon_felt',
      ...
      risk_indicator: null,
      source_locator: 'results.table_1',
      source_text_hash: 'hash-benchmark-pending-001',
      payload: {
        locator: 'results.table_1',
      },
      created_at: '2026-04-14T12:00:00.000Z',
  ...
  source_artifacts: [
    {
      artifact_id: 'artifact-catalog-pending-001',
      source_document_id: 'source-doc-catalog-pending-001',
      local_path: null,
      file_name: 'pending-catalog-evidence.pdf',
      file_hash: 'sha256:pending-catalog-evidence',
      ...
      veracity_score: {
        ...
        components: {
          source_rigor: 0.7,
          metadata_completeness: 0.72,
          measurement_quality: 0.69,
          ...
          corroboration_conflict: 0.62,
        },
        confidence_penalties: ['awaiting analyst review'],
        notes: [],
      },
      ...
      chunks: [
        {
          chunk_id: 'chunk-pending-001',
          artifact_id: 'artifact-catalog-pending-001',
          source_document_id: 'source-doc-catalog-pending-001',
          chunk_index: 0,
          page_number: 1,
          text: 'Power density reached 1.8 W/m2 under pilot operation.',
          source_locator: 'results.table_1',
          metadata: {},
          created_at: '2026-04-14T12:00:00.000Z',
        },
        {
          chunk_id: 'chunk-pending-002',
          artifact_id: 'artifact-catalog-pending-001',
          source_document_id: 'source-doc-catalog-pending-001',
          chunk_index: 1,
          page_number: 2,
          text: 'COD removal reached 82% during monitored operation.',
          source_locator: 'results.table_2',
          metadata: {},
          created_at: '2026-04-14T12:00:00.000Z',
        },
...
describe('api runtime flow', () => {
  ...
  it('lists, inspects, and reviews external evidence catalog records through the authenticated API', async () => {
    ...
    expect(analystDetailResponse.json()).toMatchObject({
      scientific_facts: expect.arrayContaining([
        expect.objectContaining({
          field_key: 'power_density',
          decision_ready: true,
        }),
      ]),
      benchmark_records: expect.arrayContaining([
        expect.objectContaining({
          metric_type: 'power_density',
          decision_ready: true,
        }),
