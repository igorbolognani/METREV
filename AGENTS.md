...
- Describe the case-runner model as lumped 0D and isothermal. The standalone Gatti 1D development solver resolves fractional substrate by slice index, not physical biofilm depth or the broader direct-transfer research profile. Do not claim independent calibration, uncertainty propagation, or experimental validation without evidence.
